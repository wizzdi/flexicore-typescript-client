...
@Injectable()
export class LicensingProductService {
    ...
    */
    ...
    public getAllLicensingProducts(authenticationkey?: string, body?: LicensingProductFiltering, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
        ...
        return this.httpClient.post<PaginationResponse<LicensingProduct>>(`${this.basePath}/licensingProducts/getAllLicensingProducts`,
            body,
            {
