...
let DownloadService = class DownloadService {
    ...
    download(authenticationKey, fileResourceId, observe = 'body', reportProgress = false) {
    ...
    zipAndDownload(authenticationKey, body, observe = 'body', reportProgress = false) {
        let headers = this.defaultHeaders;
        ...
        return this.httpClient.post(this.basePath + `/download/zipAndDownload`, body, {
            responseType: 'blob',
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
